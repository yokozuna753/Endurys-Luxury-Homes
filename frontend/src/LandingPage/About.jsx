      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          <div className="flex flex-col">
            ...
            <p className="text-center lg:text-left text-gray-600 text-lg mb-6 leading-relaxed">
            ...
            <p className="text-center lg:text-left text-gray-600 text-lg mb-8 leading-relaxed">
            ...
            <button className="flex justify-center text-center justify-items-center w-fit  bg-gray-900 text-white px-8 py-3 font-medium hover:bg-gray-800 transition-colors duration-300">
              LEARN MORE
            </button>
            </div>
          </div>
          <div className="relative">
            <img
              ...
              alt="Luxury Interior"
              className="w-full h-96 object-cover dark:opacity-100 opacity-100 brightness-100"
            />
          </div>
        </div>
      </div>
