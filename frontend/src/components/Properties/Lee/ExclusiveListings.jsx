...
const ExclusiveListings = () => {
  ...
  const displayProperties = leeProperties.slice(0, 2);
    ...
    <div className="relative h-80 w-full overflow-hidden">
      <AnimatePresence initial={false} custom={direction}>
        <motion.img
          ...
          onClick={() =>
            navigate(`/properties/lee/exclusive-listings/${property.id}`)
          }
        ...
        {displayProperties.length > 0 ? (
          <>
            ...
            <div className="text-center">
              <button
                onClick={() =>
                  navigate("/properties/lee/exclusive-listings/all")
                }
          ...
          <div className="text-center text-white">
            <p className="text-lg">
              No exclusive listings available in Lee County at this time.
            </p>
          </div>
        )}
      </div>
